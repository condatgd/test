...
import katas.tennis.history.TennisGame;
...
class TennisGameTest {
    ...
    void whenPlayerHaveSameScore(int playerScore, String assertedScoreText) {
        TennisGame game = createScore(playerScore, playerScore);
    ...
    void whenPlayerOneHasOnePointMoreThanPlayerTwo(int playerOneScore, String assertedScoreText) {
        TennisGame game = createScore(playerOneScore, playerOneScore - 1);
    ...
    void whenPlayerOneHasTwoPointsMoreThanPlayerTwo_thenPlayerOneWins(int playerOneScore, String assertedScoreText) {
        TennisGame game = createScore(playerOneScore, playerOneScore - 2);
    ...
    private TennisGame createScore(int playerOneScore, int playerTwoScore) {
